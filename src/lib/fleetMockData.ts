...
const mockFleetMembers: FleetMember[] = [
  { id: 'fm-1', plate: 'ABC1D23', model: 'Fiat Argo', color: 'Vermelho', ownerId: 'user-female-client', ownerName: 'Ana Cliente', joinedAt: '2025-01-05T10:00:00Z' },
  { id: 'fm-2', plate: 'DEF4G56', model: 'Chevrolet Onix', color: 'Branco', ownerId: 'user-2', ownerName: 'Carlos Silva', joinedAt: '2025-01-05T11:00:00Z' },
  { id: 'fm-3', plate: 'GHI7J89', model: 'Honda Civic', color: 'Prata', ownerId: 'user-male-client', ownerName: 'Pedro Cliente', joinedAt: '2025-01-05T12:00:00Z' },
  { id: 'fm-4', plate: 'JKL1M23', model: 'Toyota Corolla', color: 'Preto', ownerId: 'user-3', ownerName: 'Maria Santos', joinedAt: '2025-01-05T13:00:00Z' },
  { id: 'fm-5', plate: 'MNO4P56', model: 'Volkswagen Polo', color: 'Azul', ownerId: 'user-4', ownerName: 'João Oliveira', joinedAt: '2025-01-05T14:00:00Z' },
  { id: 'fm-6', plate: 'QRS7T89', model: 'Hyundai HB20', color: 'Vermelho', ownerId: 'user-5', ownerName: 'Fernanda Lima', joinedAt: '2025-01-05T15:00:00Z' },
  { id: 'fm-7', plate: 'UVW1X23', model: 'Renault Kwid', color: 'Branco', ownerId: 'user-6', ownerName: 'Ricardo Costa', joinedAt: '2025-01-05T16:00:00Z' },
  { id: 'fm-8', plate: 'YZA4B56', model: 'Fiat Mobi', color: 'Prata', ownerId: 'user-7', ownerName: 'Patrícia Alves', joinedAt: '2025-01-05T17:00:00Z' },
  { id: 'fm-9', plate: 'CDE7F89', model: 'Chevrolet Tracker', color: 'Cinza', ownerId: 'user-8', ownerName: 'Lucas Mendes', joinedAt: '2025-01-05T18:00:00Z' },
  { id: 'fm-10', plate: 'GHI1J23', model: 'Jeep Compass', color: 'Preto', ownerId: 'user-9', ownerName: 'Camila Rocha', joinedAt: '2025-01-05T19:00:00Z' },
  { id: 'fm-11', plate: 'KLM4N56', model: 'BMW X1', color: 'Branco', ownerId: 'user-10', ownerName: 'André Souza', joinedAt: '2025-01-06T10:00:00Z' },
  { id: 'fm-12', plate: 'OPQ7R89', model: 'Audi A3', color: 'Azul', ownerId: 'user-11', ownerName: 'Juliana Ferreira', joinedAt: '2025-01-06T11:00:00Z' },
];
