      ...
      <PageTransition>
        <div className="min-h-screen bg-background flex items-center justify-center p-4">
          ...
          >
            ...
            <h2 className="text-xl font-semibold text-foreground mb-2">Vaga Atualizada!</h2>
        ...
        <header className="border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-50">
          <div className="max-w-lg mx-auto px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-semibold text-foreground">Editar Vaga</h1>
                <p className="text-sm text-muted-foreground">{condominio?.nome || "Carregando..."}</p>
              </div>
            </div>
          </div>
        </header>
